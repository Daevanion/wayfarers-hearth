...
- Owned dossiers show four secret-chapter plaques (`???`) under the portrait and Level up column. An unsealed chapter becomes an opaque Chronicle-style button with the story title. Click to read the Word-doc text and story portraits (fade in / fade out). Portraits in the reader open that character's dossier.
- Full Lorebook lists every World Lore chapter as a card. Unsealed cards open the same story reader (fade in / fade out); sealed cards stay dimmed until the special order is done.
